  ...
  return (
    <div>
      ...
      <div className="compare-search">
        <p>Date From:</p>
        <input  type="text" placeholder="YYYY-MM-DD" onChange={(e)=>setFromDate(e.target.value)}/>
        <p>Date To:</p>
        <input  type="text" placeholder="YYYY-MM-DD" onChange={(e)=>setToDate(e.target.value)}/>
